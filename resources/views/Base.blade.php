    ...
    <body>
        <div id = "Inicio">
            <div id = "InicioIzquierda">
                <img src = "{{ asset('Imagenes/General/LogoTipo.png') }}" style = "background-color: rgb(0, 0, 0); width: 100%; height: 100%;">
            </div>
            <div id = "InicioDerecha">
                ...
                <div style = "width: 100%; height: 10%; display: flex; justify-content: right;">
                    <table class = "BarraInicio">
                        <thead>
                            <tr>
                                <th><h1><a  class = "Link_Normal" href = "{{ route('Inicio') }}">Inicio</a></h1></th>
                                <th><h1><a class = "Link_Normal" href = "{{ route('Catalogo') }}">Catalogo</a></h1></th>
                                <th><h1><a class = "Link_Normal" href = "{{ route('Servicios', ['Servicio' => 'Actividades', 'Imagen' => urlencode('Actividades.png')]) }}">Servicios</a></h1></th>
                                <th><h1><a class = "Link_Normal" href = "{{ route('Resultados') }}">Resultados</a></h1></th>
                                <th><h1><a class = "Link_Normal" href = "{{ route('AboutUs') }}">About us</a></h1></th>
                            </tr>
                        </thead>
                    </table>
                </div>
