...
@section('contenido')
<h1 id = "SeccionTitulo" class = "Titulo" data-seccion = "{{ $Seccion }}" data-producto = "{{ $Producto }}">{{ $Seccion }}</h1>
...
<div class = "BaseCatalogo">
    <div id = "MasBuscados" class = "Buscados">
        <div id = "astronomia" class = "S0 SA" data-producto = "0" style = "background-image: url({{asset ('Imagenes/Catalogo/Astronomia.png') }});">
        </div>
        <div id = "astrologia" class = "S0 SA" data-producto = "1" style = "background-image: url({{asset ('Imagenes/Catalogo/Astrologia.png') }});">
        </div>
        <div id = "geografia" class = "S1 SA" data-producto = "0" style = "background-image: url({{asset ('Imagenes/Catalogo/Geografia.png') }});">
        </div>
        <div id = "historia" class = "S2 SA" data-producto = "0" style = "background-image: url({{asset ('Imagenes/Catalogo/Historia.png') }});">
        </div>
        <div id = "idiomas" class = "S3 SA" data-producto = "0" style = "background-image: url({{asset ('Imagenes/Catalogo/Idiomas.png') }});">
        </div>
        <div id = "matematicas" class = "S4 SA" data-producto = "0" style = "background-image: url({{asset ('Imagenes/Catalogo/Matematicas.png') }});">
        </div>
        <div id = "geometria" class = "S4 SA" data-producto = "1" style = "background-image: url({{asset ('Imagenes/Catalogo/Geometria.png') }});">
        </div>
        <div id = "ciencia" class = "S5 SA" data-producto = "0" style = "background-image: url({{asset ('Imagenes/Catalogo/Ciencia.png') }});">
        </div>
        <div id = "biologia" class = "S5 SA" data-producto = "1" style = "background-image: url({{asset ('Imagenes/Catalogo/Biologia.png') }});">
        </div>
        <div id = "fisica" class = "S5 SA" data-producto = "2" style = "background-image: url({{asset ('Imagenes/Catalogo/Fisica.png') }});">
        </div>
        <div id = "quimica" class = "S5 SA" data-producto = "3" style = "background-image: url({{asset ('Imagenes/Catalogo/Quimica.png') }});">
        </div>
        <div id = "programacion" class = "S6 SA" data-producto = "0" style = "background-image: url({{asset ('Imagenes/Catalogo/Programacion.png') }});">
        </div>
        <div id = "Mas" onclick = "masomenos.call(this)" data-operacion = "1" style = "height: 17vw; background-image: url({{ asset ('Imagenes/Catalogo/Vermas.png') }});">
        </div>
        <p id = "noHay"></p>
    </div>
</div>
<script>
    ...
    function masomenos(){
        ...
        let imagenes = ["url({{ asset ('Imagenes/Catalogo/Vermas.png') }})", "url({{ asset ('Imagenes/Catalogo/Vermenos.png') }})"]
