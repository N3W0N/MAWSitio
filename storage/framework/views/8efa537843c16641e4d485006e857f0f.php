...
<div class = "Seccion">
    <div class = "ImagenesSeccion" id = "InicioServicios">
        <a id ="ImagenUrl1" style = "height: 80%; width: 40%;" href = "<?php echo e(route('Servicios', ['Servicio' => 'Actividades', 'Imagen' => urlencode('Actividades.png')])); ?>">
            <img id = "ImgServicio" src = "Imagenes/Servicios/Actividades.png" style = "height: 100%; width: 100%;">
        </a>
        <a id ="ImagenUrl2" style = "height: 80%; width: 40%;" href = "<?php echo e(route('Servicios', ['Servicio' => 'Cafeteria', 'Imagen' => urlencode('Cafeteria.png')])); ?>">
...
<script>
    function Servicios(direccion, Seccion){
        ...
        let urls = ["<?php echo e(route('Servicios', ['Servicio' => 'Actividades', 'Imagen' => urlencode('Actividades.png')])); ?>", "<?php echo e(route('Servicios', ['Servicio' => 'Cafeteria', 'Imagen' => urlencode('Cafeteria.png')])); ?>", "<?php echo e(route('Servicios', ['Servicio' => 'Clases', 'Imagen' => urlencode('Clases.png')])); ?>", "<?php echo e(route('Servicios', ['Servicio' => 'Computacion', 'Imagen' => urlencode('Computacion.png')])); ?>", "<?php echo e(route('Servicios', ['Servicio' => 'Papeleria', 'Imagen' => urlencode('Papeleria.png')])); ?>", "<?php echo e(route('Servicios', ['Servicio' => 'Soporte', 'Imagen' => urlencode('Soporte.png')])); ?>"]
        let contador = 0;
...
<?php echo $__env->make('Base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Mejora_BPC\resources\views/Inicio.blade.php ENDPATH**/ ?>