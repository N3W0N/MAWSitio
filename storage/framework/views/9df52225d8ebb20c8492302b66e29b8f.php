...
<h1 id = "title" class = "Titulo" data-imagen = "<?php echo e(urldecode($Imagen)); ?>"><?php echo e($Servicio); ?></h1>
<div id = "foco">
    <div>
        <img id = "Imagen" src = "<?php echo e(asset('Imagenes/Inicio/Tienda.svg')); ?>">
...
<div class = "BaseCatalogo" style = "background-color: rgba(255, 202, 58, 0.49);">
    <div class = "Buscados" style = "background-color: rgba(255, 202, 58, 0.49);">
        <div onclick = "cambiodeservicio('<?php echo e(asset('Imagenes/Servicios/Actividades.png')); ?>', 'Actividades')" style = "background-image: url(<?php echo e(asset ('Imagenes/Servicios/Actividades.png')); ?>);">
        </div>
        <div onclick = "cambiodeservicio('<?php echo e(asset('Imagenes/Servicios/Cafeteria.png')); ?>', 'Cafeteria')" style = "background-image: url(<?php echo e(asset ('Imagenes/Servicios/Cafeteria.png')); ?>);">
        </div>
        <div onclick = "cambiodeservicio('<?php echo e(asset('Imagenes/Servicios/Clases.png')); ?>', 'Clases')" style = "background-image: url(<?php echo e(asset ('Imagenes/Servicios/Clases.png')); ?>);">
        </div>
        <div onclick = "cambiodeservicio('<?php echo e(asset('Imagenes/Servicios/Computacion.png')); ?>', 'Computacion')" style = "background-image: url(<?php echo e(asset ('Imagenes/Servicios/Computacion.png')); ?>);">
        </div>
        <div onclick = "cambiodeservicio('<?php echo e(asset('Imagenes/Servicios/Papeleria.png')); ?>', 'Papeleria')" style = "background-image: url(<?php echo e(asset ('Imagenes/Servicios/Papeleria.png')); ?>);">
        </div>
        <div onclick = "cambiodeservicio('<?php echo e(asset('Imagenes/Servicios/Soporte.png')); ?>', 'Soporte')" style = "background-image: url(<?php echo e(asset ('Imagenes/Servicios/Soporte.png')); ?>);">
        </div>
    </div>
</div>
<script>
    window.addEventListener("load", function (){   
        ...
        let basePath = "<?php echo e(asset('Imagenes/Servicios/')); ?>/";
...
<?php echo $__env->make('Base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Mejora_BPC\resources\views/Servicios.blade.php ENDPATH**/ ?>